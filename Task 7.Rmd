...
inputPanel(
  ...
  selectInput("plotg", "Choose plot type",
      list(`Trend line` = "gline",
           `Points alone` = "gpoints",
           `Points with line segments` = "gpointsline")
    )
)
...
renderPlot({
 ...
 gline = g + geom_smooth(method = "lm", se = FALSE)

 gpoints = g

 gpointsline = g + geom_line()
  
 if(input$plotg == "gline") print(gline)
 
 if(input$plotg == "gpoints") print(gpoints)
 
 if(input$plotg == "gpointsline") print(gpointsline)
